...
Version: Tizen_exynos9110_20201008_1_6b74f44
Release: 1
License: GPL-2.0
Group: System/Kernel
...
%if "%{?sec_product_feature_bootloader_target_type}" == "undefined"
%define TYPE ""
%else
%define TYPE %{?sec_product_feature_bootloader_target_type}
%endif
...
./release_obs.sh %{RELEASE} %{MODEL} %{TYPE} %{SIZE} %{CARRIER}
