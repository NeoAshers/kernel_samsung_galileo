...
#if defined(CONFIG_MACH_A7LTE) || defined(CONFIG_GALILEO) || defined(CONFIG_PULSE) || \
	defined(CONFIG_RENAISSANCE)
#define PINCTL_DELAY 50
#endif /* CONFIG_MACH_A7LTE || CONFIG_GALILEO || CONFIG_PULSE || CONFIG_RENAISSANCE */
...
extern void mmc_ctrl_power(struct mmc_host *host, bool onoff);
	...
	* CONFIG_SOC_EXYNOS9110 - GALILEO/PULSE/RENAISSANCE
	*/
