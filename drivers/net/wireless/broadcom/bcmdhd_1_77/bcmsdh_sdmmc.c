...
#if defined(CONFIG_SOC_EXYNOS7885) || defined(CONFIG_GALILEO) || defined(CONFIG_PULSE) || \
...
#endif	/* CONFIG_SOC_EXYNOS7885 || CONFIG_GALILEO || CONFIG_PULSE || CONFIG_RENAISSANCE */
