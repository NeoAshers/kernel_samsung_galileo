...
dhd_apply_default_clm(dhd_pub_t *dhd, char *clm_path)
{
	...
	{
		char suffix[10] = {0, };
		if (dhd_is_430131(dhd->bus, suffix)) {
			int left;
			strncpy(blob_path_430131, clm_blob_path, sizeof(blob_path_430131)-1);
			...
			clm_blob_path = blob_path_430131;
		}
		DHD_ERROR(("%s clm_blob_path(%s)\n", __FUNCTION__, clm_blob_path));
	}
#endif /* CONFIG_BCM43012 */
