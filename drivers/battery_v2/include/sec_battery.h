...
#define SEC_BAT_CURRENT_EVENT_LOW_CURRENT_TCT	0x40000

#define SIOP_EVENT_NONE		0x0000
#define SIOP_EVENT_WPC_CALL	0x0001

#if defined(CONFIG_SEC_BATT_FACTORY)             // SEC_FACTORY
...
struct sec_battery_info {
	...
	struct wake_lock lpcharge_wake_lock;
	int lpcharge_boost;
	...
	bool incompatible_wpc;

	int darkzone_cnt;
	int is_darkzone;
	struct timespec darkzone_ts;
	struct delayed_work darkzone_check_work;
...
enum {
	...
	CHG_RETAIL_MODE,
	WC_OP_FREQ_STRENGTH,
	BATT_TUNE_WIRED_FAST_CHARGE_CURRENT,
	ACOK_COUNT,
	PDETB_COUNT,
	CHG_DEBUG_LIST,
	CHG_DEBUG_VALUE,
...
enum {
	USB_CHG_ONOFF_DEFAULT = 0,
	USB_CHG_ONOFF_DISABLE,
	USB_CHG_ONOFF_ENABLE,
};
