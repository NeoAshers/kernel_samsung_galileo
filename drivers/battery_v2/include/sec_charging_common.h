...
#define SEC_BATTERY_CABLE_WPC_POWER_SHARE	110

/* This definiion is only for tizen gear series */
#define SEC_BATTERY_CABLE_INCOMPATIBLE_WPC	11
...
enum power_supply_ext_property {
	...
	POWER_SUPPLY_EXT_PROP_INCOMPATIBLE_WPC,
	POWER_SUPPLY_EXT_PROP_IS_RECHARGE,
	POWER_SUPPLY_EXT_PROP_UPDATE_BATTERY_DATA,
	POWER_SUPPLY_EXT_PROP_SWELLING_MODE,
	POWER_SUPPLY_EXT_PROP_SLATE_MODE,
	POWER_SUPPLY_EXT_PROP_CHG_IN_OK,
	POWER_SUPPLY_EXT_PROP_WPC_ONLINE,
	POWER_SUPPLY_EXT_PROP_FORCED_JIG_MODE,
	POWER_SUPPLY_EXT_PROP_STORE_MODE,
	POWER_SUPPLY_EXT_PROP_WPC_VOUT_OFF,
	POWER_SUPPLY_EXT_PROP_LONG_LIFE_STEP,
	POWER_SUPPLY_EXT_PROP_BOOT_BOOST_CHARGE,
	POWER_SUPPLY_EXT_PROP_COOL_DOWN_MODE,
	POWER_SUPPLY_EXT_PROP_POWER_SHARING_CHARGE,
	POWER_SUPPLY_EXT_PROP_SET_VOUT_IRQ,
	POWER_SUPPLY_EXT_PROP_WIRELESS_OP_FREQ_STRENGTH,
	POWER_SUPPLY_EXT_PROP_CHECK_DROP_CV,
	POWER_SUPPLY_EXT_PROP_DEBUG_INFO,
	POWER_SUPPLY_EXT_PROP_BATTERY_CAPACITY_UPDATE,
	POWER_SUPPLY_EXT_PROP_WPC_TARGET_VOUT,
	POWER_SUPPLY_EXT_PROP_DARKZONE_CHECK,
	POWER_SUPPLY_EXT_PROP_HALF_BRIDGE_MODE,
	POWER_SUPPLY_EXT_PROP_DEVICE_ID,
};

enum sec_battery_debug_info{
	DEBUG_INFO_ACOK_CNT,
	DEBUG_INFO_PDETB_CNT,
	DEBUG_INFO_MODE_LST,
	DEBUG_INFO_NODE_VAL,
	DEBUG_INFO_WIRELESS_STATUS,
	DEBUG_INFO_WIRELESS_ERR_STATUS,
};
...
enum sec_wireless_pad_mode {
	...
	SEC_WIRELESS_PAD_WPC_POWER_SHARE,
...
enum sec_battery_full_charged {
	...
	/* SOC check and additional full condition with charger power supply property*/
	SEC_BATTERY_FULLCHARGED_SOC_CHGPSY,
};
...
#define WPC_MODE_NORMAL			0
#define WPC_MODE_SWELL_ENTER	1
#define WPC_MODE_SWELL_EXIT		2
#define WPC_MODE_BOOT			3
#define WPC_MODE_WAKEUP			4
#define WPC_MODE_ATTACH			5
#define WPC_MODE_IDT			6
#define WPC_MODE_VOUT_OFF		7

#define WPC_ON_PAD	0
#define WPC_OFF_PAD	1
...
struct sec_battery_platform_data {
	...
	int swelling_power_share_high_temp_block;
	int swelling_power_share_high_temp_recov;
	...
	int default_ta_charging_current;
	...
	unsigned int full_check_soc_1st;
	unsigned int full_check_soc_2nd;

	unsigned int pd_charging_charge_power;
	unsigned int nv_charge_power;

	unsigned int expired_time;
	unsigned int incompatible_expired_time;
	unsigned int swell_expired_time;
	unsigned int recharging_expired_time;
	bool single_charger_path;
	int standard_curr;

	int incompatible_wpc_current;
	int store_mode_wpc_current;
	int boot_charge_current;
	int tct_low_current;

	int darkzone_expired_time;

	int num_tx_type;
	struct sec_bat_tx_type *wireless_tx_type;
...
#define is_nv_wireless_type(cable_type)	( \
	...
	cable_type == SEC_BATTERY_CABLE_WPC_POWER_SHARE || \
