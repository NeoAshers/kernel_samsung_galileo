...
struct pmucal_seq pmucal_lpm_init[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLK_CON_MUX_MUX_CLK_CMGP_USI3", 0x11C00000, 0x102c, (0x1 << 0), (0x0 << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLK_CON_MUX_MUX_CLK_CMGP_USI2", 0x11C00000, 0x1028, (0x1 << 0), (0x0 << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLK_CON_MUX_MUX_CLK_CMGP_USI1", 0x11C00000, 0x1024, (0x1 << 0), (0x0 << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLK_CON_MUX_MUX_CLK_CMGP_USI0", 0x11C00000, 0x1020, (0x1 << 0), (0x0 << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLK_CON_MUX_MUX_CLK_CMGP_I2C3", 0x11C00000, 0x1010, (0x1 << 0), (0x0 << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLK_CON_MUX_MUX_CLK_CMGP_I2C2", 0x11C00000, 0x100c, (0x1 << 0), (0x0 << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLK_CON_MUX_MUX_CLK_CMGP_I2C1", 0x11C00000, 0x1008, (0x1 << 0), (0x0 << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLK_CON_MUX_MUX_CLK_CMGP_I2C0", 0x11C00000, 0x1004, (0x1 << 0), (0x0 << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLK_CON_MUX_MUX_CLK_CMGP_ADC", 0x11C00000, 0x1000,  (0x1 << 0), (0x0 << 0), 0, 0, 0xffffffff, 0),
};
