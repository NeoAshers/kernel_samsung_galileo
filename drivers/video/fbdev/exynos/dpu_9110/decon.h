...
/* Bring up DEBUG */
//#define VADDR_COLORMAP
//#define BRINGUP_DSIM_BIST
//#define PHY_FRAMEWORK_DIS
//#define SEL_RESET_FROM_SYSREG

#define DECON_MODULE_NAME	"exynos-decon"
#define MAX_NAME_SIZE		32
#define MAX_PLANE_CNT		3
/* When using 10bit image, need 4 addresses */
#define MAX_PLANE_ADDR_CNT	3
...
#define DECON_WIN_UPDATE_IDX	(3)

#define MAX_FRM_DONE_WAIT	34

#ifndef CONFIG_SEC_UB_DISCONNECT
#define DECON_TIMEOUT_RECOVERY
#endif
...
struct decon_device {
	...
	struct delayed_work hiber_block_dwork;
#ifdef CONFIG_PANEL_TEMP_COMPENSATION
	struct delayed_work temp_compensation_dwork;
#endif
#ifdef CONFIG_EXYNOS9110_BTS
	...
	int recovery_cnt;
	u32 recovery_te_cnt;
	int recovery_working;
	int recovery_worked;
#endif
	int hiber_state;
	int update_count;
	struct delayed_work	load_timeout_cnt_dwork;
	pid_t commit_pid[3];
#ifdef CONFIG_DRM_TDM_FRAME_DONE
	int frame_num;
#endif
...
#define S3CFB_AOD_SET_TIME   _IOW('F', 231, struct sclk_time_cfg_v2)
#define S3CFB_AOD_SET_ANALOG   _IOW('F', 232, struct sclk_analog_cfg_v2)
#define S3CFB_AOD_SET_DIGITAL  _IOW('F', 233, struct sclk_digital_cfg_v2)
#define S3CFB_AOD_ENTER			_IOW('F', 234, u32)
#define S3CFB_AOD_EXIT         _IOW('F', 235, u32)
#define S3CFB_AOD_SET_ICON     _IOW('F', 236, struct sclk_icon_cfg_v2)
#define S3CFB_AOD_SET_MOVE	_IOW('F', 237, struct sclk_move_cfg_v2)

#define S3CFB_AFPC_GET_PANEL_ID	_IOR('F', 238, struct afpc_panel_v2)
#define S3CFB_AFPC_SET_COMPENSATION  _IOW('F', 239, struct afpc_compensation_v2)
