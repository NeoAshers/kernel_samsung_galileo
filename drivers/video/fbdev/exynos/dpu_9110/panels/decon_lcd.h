...
//#define ENABLE_PRINT_DISPLAY_DQA
...
struct decon_lcd {
	...
	unsigned int support_multi_panel;
	int panel_vendor;
#endif
#ifdef CONFIG_TIZEN
	const char* name;
...
enum aod_panel_refresh_rate {
	AOD_PANEL_REFRESH_RATE_LOW,
	AOD_PANEL_REFRESH_RATE_HIGH,
};
...
struct aod_config {
	...
	union {
		...
		enum aod_panel_refresh_rate panel_refresh_rate;
	};
};
