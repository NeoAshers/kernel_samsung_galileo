...
#else
#define DEFAULT_MODEL_NAME	"BCM4774IUB2G"
#endif
...
//int ssp_ipc_async(struct ssp_data *, struct ssp_msg *);
//int ssp_ipc_sync(struct ssp_data *, struct ssp_msg *, int);
#ifdef CONFIG_SENSORS_SSP_CHUB
