...
#define RPC_ALLOW_SSP			"RPC:SSP=1"
#define RPC_DENAY_SSP			"RPC:SSP=0"
#undef DEBUG_1HZ_STAT
...
/* patch_ram(FW) type bits */
enum {
	LEGACY_BBD_PATCH_RAM,
	NORMAL_BBD_PATCH_RAM,
	WOM_BBD_PATCH_RAM,
};
...
void bcm_update_irq_status(void);
#endif
...
typedef struct {
	...
	/* to get wom_state */
	int (*get_wom_state)(void *ssh_data, bool *value);
} bbd_callbacks;
