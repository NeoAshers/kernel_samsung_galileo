...
static unsigned char bbd_patch_47755B1[] =
{
#include "pulse_20100800b1.h"
};
...
#if defined(CONFIG_PULSE)
			if (system_rev == 4){
				curr_bbd_patch = bbd_patch_47755B1;
				bbd_patch_sz = sizeof(bbd_patch_47755B1);
			}
			else{
