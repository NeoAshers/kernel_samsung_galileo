...
#define GNSS_IOCTL_RESET_RELEASE    _IO(GNSS_IOC_MAGIC, 0x08)
#define GNSS_IOCTL_PERI_READ        _IO(GNSS_IOC_MAGIC, 0x09)
#define GNSS_IOCTL_PERI_WRITE       _IO(GNSS_IOC_MAGIC, 0x10)
#define GNSS_IOCTL_FAULT			_IO(GNSS_IOC_MAGIC, 0x11)
...
struct gnssctl_ops {
	...
	int (*gnss_force_set_fault)(struct gnss_ctl *);
};
