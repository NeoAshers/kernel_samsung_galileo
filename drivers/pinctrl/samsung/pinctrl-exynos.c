...
static struct samsung_pin_bank_data exynos9110_pin_banks0[] = {
	...
	EXYNOS8_PIN_BANK_EINTN(bank_type_7, 4, 0x040, "gpq0"),
};
...
static struct samsung_pin_bank_data exynos9110_pin_banks2[] = {
	EXYNOS9_PIN_BANK_EINTG(bank_type_6, 1, 0x000, "gpm4", 0x00, 0x00),
	EXYNOS9_PIN_BANK_EINTG(bank_type_6, 1, 0x020, "gpm5", 0x04, 0x04),
	EXYNOS9_PIN_BANK_EINTG(bank_type_6, 1, 0x040, "gpm6", 0x08, 0x08),
	EXYNOS9_PIN_BANK_EINTG(bank_type_6, 1, 0x060, "gpm7", 0x0C, 0x0C),
	EXYNOS9_PIN_BANK_EINTG(bank_type_6, 1, 0x080, "gpm8", 0x10, 0x10),
	EXYNOS9_PIN_BANK_EINTG(bank_type_6, 1, 0x0A0, "gpm9", 0x14, 0x14),
	EXYNOS9_PIN_BANK_EINTG(bank_type_6, 1, 0x0C0, "gpm10", 0x18, 0x18),
	EXYNOS9_PIN_BANK_EINTG(bank_type_6, 1, 0x0E0, "gpm11", 0x1C, 0x1C),
	EXYNOS9_PIN_BANK_EINTG(bank_type_6, 1, 0x100, "gpm12", 0x20, 0x20),
	EXYNOS9_PIN_BANK_EINTG(bank_type_6, 1, 0x120, "gpm13", 0x24, 0x24),
	EXYNOS9_PIN_BANK_EINTG(bank_type_6, 1, 0x140, "gpm14", 0x28, 0x28),
	EXYNOS9_PIN_BANK_EINTG(bank_type_6, 1, 0x160, "gpm15", 0x2C, 0x2C),
	EXYNOS9_PIN_BANK_EINTG(bank_type_6, 1, 0x180, "gpm16", 0x30, 0x30),
	EXYNOS9_PIN_BANK_EINTG(bank_type_6, 1, 0x1A0, "gpm17", 0x34, 0x34),
	EXYNOS9_PIN_BANK_EINTG(bank_type_6, 1, 0x1C0, "gpm18", 0x38, 0x38),
	EXYNOS9_PIN_BANK_EINTG(bank_type_6, 1, 0x1E0, "gpm19", 0x3C, 0x3C),
};

/* pin banks of exynos9110 pin-controller 3 (DISPAUD) */
static struct samsung_pin_bank_data exynos9110_pin_banks3[] = {
	EXYNOS9_PIN_BANK_EINTG(bank_type_6, 5, 0x000, "gpb0", 0x00, 0x00),
	EXYNOS9_PIN_BANK_EINTG(bank_type_6, 5, 0x020, "gpb1", 0x04, 0x08),
};

/* pin banks of exynos9110 pin-controller 4 (FSYS) */
static struct samsung_pin_bank_data exynos9110_pin_banks4[] = {
...
/* pin banks of exynos9110 pin-controller 5 (PERI) */
static struct samsung_pin_bank_data exynos9110_pin_banks5[] = {
	...
	EXYNOS9_PIN_BANK_EINTG(bank_type_6, 4, 0x060, "gpp3", 0x0C, 0x0C),
	...
	EXYNOS9_PIN_BANK_EINTG(bank_type_6, 3, 0x1C0, "gpg7", 0x38, 0x38),
};

/* pin banks of exynos9110 pin-controller 6 (VTS) */
static struct samsung_pin_bank_data exynos9110_pin_banks6[] = {
	EXYNOS9_PIN_BANK_EINTG(bank_type_6, 3, 0x000, "gpv0", 0x00, 0x00),
};

const struct samsung_pin_ctrl exynos9110_pin_ctrl[] = {
	{
		/* pin-controller instance 0 ALIVE data */
		.pin_banks	= exynos9110_pin_banks0,
		.nr_banks	= ARRAY_SIZE(exynos9110_pin_banks0),
		.eint_gpio_init = exynos_eint_gpio_init,
		.eint_wkup_init = exynos_eint_wkup_init,
		.suspend	= exynos_pinctrl_suspend,
		.resume		= exynos_pinctrl_resume,
	}, {
		/* pin-controller instance 1 CMGP_ALIVE data */
		.pin_banks	= exynos9110_pin_banks1,
		.nr_banks	= ARRAY_SIZE(exynos9110_pin_banks1),
		.eint_gpio_init = exynos_eint_gpio_init,
		.eint_wkup_init = exynos_eint_wkup_init,
		.suspend	= exynos_pinctrl_suspend,
		.resume		= exynos_pinctrl_resume,
		...
		.pin_banks	= exynos9110_pin_banks2,
		.nr_banks	= ARRAY_SIZE(exynos9110_pin_banks2),
		.eint_gpio_init = exynos_eint_gpio_init,
		.suspend	= exynos_pinctrl_suspend,
		.resume		= exynos_pinctrl_resume,
	}, {
		/* pin-controller instance 3 DISPAUD data */
		.pin_banks	= exynos9110_pin_banks3,
		.nr_banks	= ARRAY_SIZE(exynos9110_pin_banks3),
		//.eint_gpio_init = exynos_eint_gpio_init,
		//.suspend	= exynos_pinctrl_suspend,
		//.resume	= exynos_pinctrl_resume,
	}, {
		/* pin-controller instance 4 FSYS data */
		.pin_banks	= exynos9110_pin_banks4,
		.nr_banks	= ARRAY_SIZE(exynos9110_pin_banks4),
		.eint_gpio_init = exynos_eint_gpio_init,
		.suspend	= exynos_pinctrl_suspend,
		.resume		= exynos_pinctrl_resume,
	}, {
		/* pin-controller instance 5 PERI data */
		.pin_banks	= exynos9110_pin_banks5,
		.nr_banks	= ARRAY_SIZE(exynos9110_pin_banks5),
		.eint_gpio_init = exynos_eint_gpio_init,
		.suspend	= exynos_pinctrl_suspend,
		.resume		= exynos_pinctrl_resume,
	}, {
		/* pin-controller instance 6 VTS data */
		.pin_banks	= exynos9110_pin_banks6,
		.nr_banks	= ARRAY_SIZE(exynos9110_pin_banks6),
		//.eint_gpio_init = exynos_eint_gpio_init,
		//.suspend	= exynos_pinctrl_suspend,
		//.resume		= exynos_pinctrl_resume,
	},
...
int exynos9110_secgpio_get_nr_gpio(void)
{
	int i, j;
	int nr_gpio = 0;

	for (i = 0; i < ARRAY_SIZE(exynos9110_pin_ctrl); i++) {
		for(j = 0; j < exynos9110_pin_ctrl[i].nr_banks; j++)
			nr_gpio += exynos9110_pin_ctrl[i].pin_banks[j].nr_pins;
	}
