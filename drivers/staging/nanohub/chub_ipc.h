...
#elif defined(AP_IPC)
#include "comms.h"
#if defined(CONFIG_CHRE_SENSORHUB_HAL)	/* SEOS Support */
#define PACKET_SIZE_MAX (NANOHUB_PACKET_SIZE_MAX)
#else	/* EMBOS Support */
...
#define PACKET_SIZE_MAX (4096) /* 4K From 8K 2019.05.20 */
#endif
...
void ipc_update_pginfo(u32 pgCnt, u64 pgTime, u64 curTime);
void ipc_update_cginfo(u32 cgCnt, u64 cgTime, u64 curTime);
#endif
