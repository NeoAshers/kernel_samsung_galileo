	...
	struct alarm_expire_stat *alarm_expire, size_t n)
{
	...
	unsigned long total_wakeup_count = 0, total_expire_count = 0;
	int i = 0;
	...
	for (i = 0; i < n; i++) {
		...
		alarm_expire[i].total_wakeup_count = 0;
		alarm_expire[i].total_expire_count = 0;
	}
	...
	for (i = 0; i < n; i++) {
		alarm_expire[i].total_wakeup_count = total_wakeup_count;
		alarm_expire[i].total_expire_count = total_expire_count;
	}
}
#endif
