...
#define DRM_TDM_SET_FRAME_DONE		0x51
#endif
/* PP - Post Processing */
...
#ifdef CONFIG_DRM_TDM_FRAME_DONE
#define DRM_IOCTL_TDM_SET_FRAME_DONE	DRM_IOWR(DRM_COMMAND_BASE + \
			DRM_TDM_SET_FRAME_DONE, int)
#endif
...
#ifdef CONFIG_DRM_TDM_FRAME_DONE
#define TDM_FRAME_DONE_EVENT 0x80000003
#endif
