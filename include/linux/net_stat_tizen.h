...
extern int net_stat_tizen_get_stat(
					struct net_stat_tizen_emon *emon_stat, size_t n);
extern int net_stat_tizen_get_stat_emon(int type,
					struct net_stat_tizen_emon *emon_stat, size_t n);
#else
...
static inline int net_stat_tizen_update_wifi(struct net_device *dev,
					enum net_stat_wifi_event event)
{	return 0;}
static inline int net_stat_tizen_get_stat(
					struct net_stat_tizen_emon *emon_stat, size_t n);
{	return 0;}
static inline int net_stat_tizen_get_stat_emon(int type,
					struct net_stat_tizen_emon *emon_stat, size_t n);
{	return 0;}
#endif
