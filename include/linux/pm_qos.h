...
#define PM_QOS_TOUCH_PRESS_DEFAULT_VALUE	839000
#define PM_QOS_TOUCH_MOVE_DEFAULT_VALUE	839000
#define PM_QOS_TOUCH_RELEASE_DEFAULT_VALUE	839000
...
struct pm_qos_request {
	...
	ktime_t total_time;
	ktime_t last_time;
	unsigned long add_req_count;
	unsigned long long update_req_count;
	unsigned long remove_req_count;
	unsigned long long qos_req_count;
	unsigned int active;
#endif
};
