...
struct cpuidle_stat_hotplug {
	ktime_t online_time;
	ktime_t last_onlie_time;
...
struct cpuidle_stat_info {
	...
	struct cpuidle_stat_hotplug hp;
};
...
int cpuidle_stats_get_stats_emon(int type, struct emon_cpuidle_stat *cpuidle_stat);
