...
#define S2MPW02_CV_DROP_FORCE_CLEAR		1
#define S2MPW02_CV_DROP_NORMAL_CLEAR	0

#define S2MPW02_CV_DROP_CLEAR		0
#define S2MPW02_CV_DROP_LEVEL_1		1
#define S2MPW02_CV_DROP_LEVEL_2		2
