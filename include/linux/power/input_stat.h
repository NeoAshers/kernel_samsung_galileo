...
extern int input_stat_get_stat(
					struct input_stat_emon *emon_stat);
extern int input_stat_get_stat_emon(int type,
 					struct input_stat_emon *emon_stat);
#else
static inline int input_stat_get_stat(
					struct input_stat_emon *emon_stat) {	return 0;}
static inline int input_stat_get_stat_emon(int type,
 					struct input_stat_emon *emon_stat) {	return 0;}
#endif
