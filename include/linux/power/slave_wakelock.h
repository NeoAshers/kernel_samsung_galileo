...
#ifdef CONFIG_SLAVE_WAKELOCK
extern void slave_wakelock_get_large_prevent_time(
	int type, struct emon_slave_wakelock *slwl, int size);
#else
static inline void slave_wakelock_get_large_prevent_time(
	int type, struct emon_slave_wakelock *slwl, int size) {}
#endif
