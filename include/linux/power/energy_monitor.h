...
enum energy_mon_type {
	...
	ENERGY_MON_TYPE_NOT_CHARGING,
	ENERGY_MON_TYPE_FULL,
	ENERGY_MON_TYPE_MAX
};
...
enum energy_mon_wakeup_source {
	...
	ENERGY_MON_WAKEUP_GNSS = 6,
	ENERGY_MON_WAKEUP_NFC = 7,
	ENERGY_MON_WAKEUP_ETC = 8,

	/* special value for wrist up */
	ENERGY_MON_WAKEUP_WU = 9,
	ENERGY_MON_WAKEUP_NOTI = 10,
...
enum energy_mon_state {
	...
	ENERGY_MON_STATE_NOT_CHARGING = 2,
	ENERGY_MON_STATE_FULL = 3,

	/* Add here */

	ENERGY_MON_STATE_UNKNOWN = 4,
};
