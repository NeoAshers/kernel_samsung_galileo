...
extern int lbs_stat_get_stat(
		struct lbs_stat_emon *emon_stat);
extern int lbs_stat_get_stat_emon(int type,
		struct lbs_stat_emon *emon_stat, size_t n);
#else
static inline int lbs_stat_get_stat(
		struct lbs_stat_emon *emon_stat)
{	return 0;}
static inline int lbs_stat_get_stat_emon(int type,
		struct lbs_stat_emon *emon_stat, size_t n)
{	return 0;}
#endif
#endif /* __LBS_STAT_H */
