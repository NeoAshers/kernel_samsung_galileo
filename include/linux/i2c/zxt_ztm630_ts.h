...
#define	ztm630_TS_DEVICE		"ztm630_ts"
...
#ifdef CONFIG_INPUT_TIZEN_BEZEL
...
#if USE_CHECKSUM
#define	ZTM630_CHECK_SUM		0x55aa
#endif
...
struct ztm_bezel_ddata {
	...
	enum wheel_intv_t		interval_mode;
	u32		dqa_cw_cnt;
	u32		dqa_ccw_cnt;
	u32		dqa_err_cnt;
	u16		vib_mode;
...
/* Register Map*/
#define	ZTM630_SWRESET_CMD				0x0000
#define	ZTM630_WAKEUP_CMD				0x0001
#define	ZTM630_DEEP_SLEEP_CMD			0x0004
#define	ZTM630_SLEEP_CMD				0x0005
#define	ZTM630_CLEAR_INT_STATUS_CMD			0x0003
#define	ZTM630_CALIBRATE_CMD				0x0006
#define	ZTM630_SAVE_STATUS_CMD			0x0007
#define	ZTM630_SAVE_CALIBRATION_CMD			0x0008
//#define	ZTM630_I2C_START_CMD				0x000A
//#define	ZTM630_I2C_END_CMD	  			0x000B
#define	ZTM630_RECALL_FACTORY_CMD			0x000f
#define	ZTM630_THRESHOLD				0x0020
#define	ZTM630_DEBUG_REG				0x0115 /* 0~7 */
#define	ZTM630_TOUCH_MODE				0x0010
#define	ZTM630_CHIP_REVISION				0x0011
#define	ZTM630_FIRMWARE_VERSION			0x0012
#define	ZTM630_MINOR_FW_VERSION			0x0121
#define	ZTM630_VENDOR_ID				0x001C
#define	ZTM630_HW_ID					0x0014
#define	ZTM630_DATA_VERSION_REG			0x0013
#define	ZTM630_SUPPORTED_FINGER_NUM			0x0015
#define	ZTM630_EEPROM_INFO				0x0018
#define	ZTM630_INITIAL_TOUCH_MODE			0x0019
#define	ZTM630_TOTAL_NUMBER_OF_X			0x0060
#define	ZTM630_TOTAL_NUMBER_OF_Y			0x0061
#define	ZTM630_DELAY_RAW_FOR_HOST			0x007f
#define	ZTM630_BUTTON_SUPPORTED_NUM			0x00B0
#define	ZTM630_BUTTON_SENSITIVITY			0x00B2
#define	ZTM630_DUMMY_BUTTON_SENSITIVITY		0X00C8
#define	ZTM630_X_RESOLUTION				0x00C0
#define	ZTM630_Y_RESOLUTION				0x00C1
#define	ZTM630_COORD_ORIENTATION		0x00C2
#define	ZTM630_POINT_STATUS_REG			0x0080
#define	ZTM630_ICON_STATUS_REG			0x00AA
#define	ZTM630_I2C_MODE_REG				0x00E2

#define	ZTM630_GESTURE_STATE				0x01FB
#define	ZTM630_MUTUAL_AMP_V_SEL			0x02F9
#define	ZTM630_DND_SHIFT_VALUE			0x012B
#define	ZTM630_AFE_FREQUENCY				0x0100
#define	ZTM630_DND_N_COUNT				0x0122
#define	ZTM630_DND_U_COUNT				0x0135
#define	ZTM630_CONNECTED_REG				0x0062
#define	ZTM630_CONNECTED_REG_MAX			0x0078
#define	ZTM630_CONNECTED_REG_MIN			0x0079
#define	ZTM630_DND_V_FORCE				0x02F1
#define	ZTM630_DND_AMP_V_SEL				0x02F9
#define	ZTM630_DND_CP_CTRL_L				0x02bd
#define	ZTM630_RAWDATA_REG				0x0200
#define	ZTM630_EEPROM_INFO_REG			0x0018
#define	ZTM630_INT_ENABLE_FLAG			0x00f0
#define	ZTM630_PERIODICAL_INTERRUPT_INTERVAL	0x00f1
#define	ZTM630_BTN_WIDTH				0x0316
#define	ZTM630_CHECKSUM_RESULT			0x012c
#define	ZTM630_INIT_FLASH				0x01d0
#define	ZTM630_WRITE_FLASH				0x01d1
#define	ZTM630_READ_FLASH				0x01d2
#define	ZINITIX_INTERNAL_FLAG_01			0x011d
#define	ZINITIX_INTERNAL_FLAG_02			0x011e
#define	ZTM630_OPTIONAL_SETTING			0x0116
...
#define	ZTM630_M_U_COUNT				0x02F2
#define	ZTM630_M_N_COUNT				0x02F3
#define	ZTM630_M_RST0_TIME	  			0x02F5
#define	ZTM630_REAL_WIDTH				0x03A6
#define	ZTM630_FW_CHECKSUM_REG  			0x03DF
#define	ZTM630_FINGER_CNT_REG  			0x030F

#define	ZTM630_DEBUG_00				0x0115
...
struct ztm630_info {
...
#endif
	int slot_buff[MAX_SUPPORTED_FINGER_NUM];
	...
	s64				gesture_time;
	s64				normal_time;
	ktime_t				gesture_start_t;
	ktime_t				normal_start_t;
	bool				wet_mode;
	bool				noise_mode;
	u32				max_z_value;
	u8				palm_flag;
