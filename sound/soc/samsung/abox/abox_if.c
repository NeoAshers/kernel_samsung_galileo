...
#undef dev_warn
#endif
#define abox_log_if_info(prefix, fmt, args...)					\
	abox_log_info("[abox-if]" prefix fmt, ##args)
#define dev_info(dev, fmt, args...)						\
	abox_log_if_info("(%d)", fmt, dev->id == 0 ? data->id : data->id, ##args)

#define abox_log_if_err(prefix, fmt, args...)					\
	abox_log_err("[abox-if]" prefix fmt, ##args)
#define dev_err(dev, fmt, args...)						\
	abox_log_if_err("(%d)", fmt, dev->id == 0 ? data->id : data->id, ##args)

#define abox_log_if_warn(prefix, fmt, args...)					\
	abox_log_warn("[abox-if]" prefix fmt, ##args)
#define dev_warn(dev, fmt, args...)						\
	abox_log_if_warn("(%d)", fmt, dev->id == 0 ? data->id : data->id, ##args)
